...
all: $(OUT_DIR) main.o startup.o rcc_driver.o $(DEBUG_DIR)/firmware.elf
...
$(DEBUG_DIR)/firmware.elf: $(OUT_DIR)/main.o $(OUT_DIR)/startup.o $(OUT_DIR)/rcc_driver.o | $(DEBUG_DIR)
	$(Compiler) $(LDFlags) -o $@ $^
